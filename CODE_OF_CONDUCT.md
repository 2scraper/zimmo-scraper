...
- Giving and gracefully accepting constructive feedback — including a
  disagreement about a technical claim, backed by a reproduction rather
  than an assertion (see `CONTRIBUTING.md`).
...
behavior and will take appropriate, fair corrective action in response
...
be reported to the maintainers through the 2scraper organization. All
